  ...
  reducers: {
    ...
    setAddItemToCart: (state, action) => {
      ...
      if(itemIndex >= 0) {
        ...
        toast.success(`Another ${action.payload.title} added to Cart `);
      } else {
      ...
      setIncreaseItemQTY: (state, action) => { const itemIndex = state.cartItems.findIndex((item) => item.id === action.payload.id)
      ...
      setDecreaseItemQTY: (state, action) => {const itemIndex = state.cartItems.findIndex((item) => item.id === action.payload.id)
